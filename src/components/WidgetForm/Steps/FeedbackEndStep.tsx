...
export function FeedbackEndStep({ handleRestartForm }: IProps) {
  return (
    <div className="widgetEndForm">
      <svg
        width="41"
        height="40"
        viewBox="0 0 41 40"
      ...
      <span className="widgetEndFormText">Agradecemos pelo seu Feedback</span>
      <button
        className="widgetEndFormButton"
        type="button"
